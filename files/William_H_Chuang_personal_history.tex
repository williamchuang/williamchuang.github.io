...
My interest in proving theorems stemmed from Prof. Paul Zeitz's problem solving course based on his book ``The Art and Craft of Problem Solving''. It was to uncover a pattern in the number of areas in two-dimensional Euclidean space that may be partitioned by $n$ lines. Although I studied math in Taiwan, my main concentration was on how to apply mathematics to real-world situations. With the help of Prof. Zeitz's problem solving strategies, for the first time, I came up with a proof on my own that is not intended to serve a real-world problem. At that very moment, I felt delight and thrilled! Since then, I have been taking more and more pure math classes.
